...
<HTML>
    ...
    <h2><div class="header"><img src="../heart.png" height="50vh" width="60vw" >MATCHA</div></h2><br>
...
// else
//     echo "<script type='text/javascript'>alert('Sorry you are not logged in.');window.location = '../login.php';</script>";
?>