...
<a href="logout.php"><button class="logout">LogOut</button></a><br></br><br> 
            <a href="friends.php" style="float :left">Back to home</a><br>  
</header>
...
<form method="POST" enctype="multipart/form-data" class="form-horizontal" action="">
 ...
 <table class="table table-bordered table-responsive">
    ...
    <p><b>NOTE:</b>Your username must not be changed</p>
