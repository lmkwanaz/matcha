...
<button class="logout" onclick="window.location.href='myaccount.php'" >Myaccount</button>
<button class="logout" onclick="window.location.href='mypictures.php'" >MyGallary</button> 
<a href="logout.php"><button class="logout">LogOut</button></a><br>
<a href="./friends.php" style="float : left">Back to home</a><br></header><br></br></header>
