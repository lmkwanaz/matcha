...
if(isset($_POST['submit'])){
    ...
    try{
        ...
        $sexuality = htmlEntities($_POST['sexuality']);
        ...
        $stmt->execute();
        $result = "<p style='padding: 20px; color: green'>Your information has been successfully saved into our database:</p>";
    ...
    switch(error.code) {
        ...
        case error.UNKNOWN_ERROR:
            ...
            <?php if(isset($result)) echo "$result" ?>
                ...
                <div class="head1"><h1>EDDITIONAL INFORMATION</h1></div>
                 <div class="head2"><p>Please fill in the required information which will be displayed on your profile</p></div>
                ...
                Gender:<br>
                  ...
                  <select class="form-control" style="width:140px; height:10px" name="city" value="city">
                        ...
                        <option value="midrend">Midrend</option>
                  ...
                  <a href="./login.php">Login now</a></center>
