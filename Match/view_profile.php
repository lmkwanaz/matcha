...
<button class="logout" onclick="window.location.href='notification.php'"  id="notification">notification</button><br></br><br> 
<a href="friends.php" style="float:left">Back to home</a><br></header><br><br>   
                ...
                <?php
                    ...
                    try
                    {
                        ...
                        $to= $email;
                         ...
                         $subject="www.noreply@matcha.com - YOUR PROFILE WAS VIEWED";
                         ...
                         To find out more Copy the link :
                        ...
                        $result = "<p style='padding: 20px; color: green;'>This user will be notified that you viewed the profile!</p>";
              ...
              ?>
                ...
                <footer>Copyright &copy; matcha.com</footer>
